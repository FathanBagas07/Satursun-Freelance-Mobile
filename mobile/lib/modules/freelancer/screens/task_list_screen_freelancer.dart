...
class TaskListScreen extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.only(left: 20.0, top: 5), child: Text('Daftar Tugas', style: textTheme.displayMedium!.copyWith(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white))),
          ],
        ),
      ),
    );
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(mainAxisAlignment: isWide ? MainAxisAlignment.start : MainAxisAlignment.center, children: [Icon(icon, color: _saturSunBlue, size: 20), if (isWide) const SizedBox(width: 10), Flexible(child: Text(label, style: textTheme.bodyMedium!.copyWith(fontSize: 14, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis))]),
        ),
      ),
    );
  }
  ...
  Widget _buildTaskHeader(BuildContext context, String title) {
    return Padding(padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 5), child: Text(title, style: Theme.of(context).textTheme.titleLarge!.copyWith(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)));
  }
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 10),
              Text(price, style: textTheme.bodyLarge!.copyWith(fontSize: 16, fontWeight: FontWeight.bold, color: isComplete ? _saturSunGreen : _saturSunOrange)),
            ],
          ),
          ...
          Row(children: [
            ...
            const SizedBox(width: 10), 
            Text(progressLabel, style: textTheme.bodySmall!.copyWith(fontSize: 12, color: Colors.black54, fontWeight: FontWeight.w500)), 
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text('Detail', style: textTheme.bodySmall!.copyWith(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold))
              )
            )
          ]),
        ],
